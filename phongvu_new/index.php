...
<body>
    ...
    <nav class="navbar-light sticky-top main-menu py-1 custom-toggler">
        <div class="container">
            ...
            <div class="row align-items-center py-3">
                ...
                <div class="col-md-2">
                    <img src="assets/images/logo-full.svg" alt="" class="img-fluid">
                </div>
                ...
                <div class="col-md-3">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#"><i class="fas fa-desktop"></i> Điện máy - Điện gia dụng</a>
                            <a class="dropdown-item" href="#"><i class="fas fa-desktop"></i> Laptop & Macbook</a>
                            <a class="dropdown-item" href="#"><i class="fas fa-desktop"></i> Màn hình máy tính</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <form action="search.php" class="form-inline my-2 my-lg-0">
                        <input class="form-control mr-sm-2" type="search" placeholder="Tìm kiếm" name=q value="">
                        <button type="submit" class="btn btn-success my-2 my-sm-0"><i class="fa fa-search fa-fw"></i></button>
                    </form>
                </div>

                <div class="col-md-3">
                    <a class="" href="product_list.php?id=20">Khuyến mãi</a>
                    <a class="" href="product_list.php?id=25">Đơn hàng</a>
                    <a class="" href="product_list.php?id=26">Thông báo</a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="">
                                <a class="dropdown-item" href="product_list.php?id=20">Thịt bò Mỹ nhập khẩu</a>
                            </li>
                            <li class="">
                                <a class="dropdown-item" href="product_list.php?id=25">Thịt bò Úc nhập khẩu</a>
                            </li>
                            <li class="">
                                <a class="dropdown-item" href="product_list.php?id=26">Hải sản</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="">
                                <a class="dropdown-item" href="post_list.php?id=27">Ẩm thực và gia đình</a>
                            </li>
                            <li class="">
                                <a class="dropdown-item" href="post_list.php?id=28">Tin tức ẩm thực</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="container mt-4 mb-3">
        <div class="row">
            <div class="col-md-3"><img src="assets/images/promo1.webp" class="img-fluid rounded" alt=""></div>
            <div class="col-md-3"><img src="assets/images/promo2.webp" class="img-fluid rounded" alt=""></div>
            <div class="col-md-3"><img src="assets/images/promo3.webp" class="img-fluid rounded" alt=""></div>
            <div class="col-md-3"><img src="assets/images/promo4.webp" class="img-fluid rounded" alt=""></div>
        </div>
    </div>
    <!-- END PROMO -->
