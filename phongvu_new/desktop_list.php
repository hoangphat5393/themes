...
<body>
    ...
    <div class="sticky-top">
        <nav class="navbar-light main-menu">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/desktop-slide.png" alt="Phong Vũ" title="Phong Vũ">
                </div>
    ...
    <div class="promo-page-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-md-3 mb-3"><img src="assets/images/desktop-img1.png" class="img-fluid rounded" alt=""></div>
                <div class="col-6 col-md-3 mb-3"><img src="assets/images/desktop-img2.png" class="img-fluid rounded" alt=""></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="overflow-hidden">
                        <img src="assets/images/desktop-img5.png" class="img-fluid rounded" alt="Desktop">
                    </div>
                </div>
            </div>

            <div class="row main-product mb-2">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="block">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <figure class="d-none d-md-block overflow-hidden">
                                    <a href="#"><img src="assets/images/product-b1.webp" alt="" class="w-100 h-100"></a>
                                </figure>
                            </div>

                            <div class="col-md-8">

                                <div class="promo-cat-p">
                                    <div class="owl-one owl-carousel owl-theme">

                                        <div class="item promo-item p-2">
                                            <a href="#" title="">
                                                <figure>
                                                    <img class="w-100" src="assets/images/desktop-img7.jpg" alt="">
                                                    <figcaption>PC Dell Vostro 3681 PWTN15(Intel Pentium G6400/4GB/1TBHDD/Windows 10 Home SL 64-bit + Office 2019 Home & Student/WiFi 802.11ac)</figcaption>
                                                </figure>
                                                <div class="promo-price">23.490.000 ₫</div>
                                                <div class="old-price">
                                                    <span class="price">24.999.000đ ₫</span> 
        ...
        <div class="container mt-4 mb-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="overflow-hidden">
                        <img src="assets/images/desktop-img7.png" class="img-fluid rounded" alt="Desktop">
                    </div>
                </div>
            </div>
