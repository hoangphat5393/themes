...
<body>
    ...
    <div class="container product-detail my-3">
        <div class="row mb-5">
            <div class="col-md-8">
                <div class="block product-sumary py-3">
                    <div class="row">
                        <div class="col-md-5">
            ...
            <div class="col-md-4">
                <div class="block product-policy p-3">
                    <div class="benefit">Sản phẩm được miễn phí giao hàng</div>

                    <div class="subtitle">Chính sách bán hàng</div>
                    <div>Miễn phí giao hàng cho đơn hàng từ 800K</div>
                    ...
                    <a href="#" target="_blank" class="d-block mt-2">Xem chi tiết</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="block product-cus py-3">
                    <div class="block-title pl-3">Cùng thương hiệu MSI</div>
